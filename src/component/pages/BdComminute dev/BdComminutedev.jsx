...
const BdComminutedev = () => {
    return (
        <div className="py-16 bg-[#6674cc] mt-12 md:px-1 px-4">
            ...
            <div className="md:flex  container mx-auto pt-8 pb-5 justify-between items-center">
                ...
                <div className="flex md:pt-0 pt-4 md:pb-0 pb-4 md:text-xl text-base font-bold flex-col items-center text-[#fff]">
